...
import { Button } from '@/components/shadcn/carouselButton';
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={cn('min-w-0 shrink-0 grow-0 basis-full', orientation === 'horizontal' ? 'pl-8' : '', className)}
        {...props}
      />
    );
  }
      ...
      <div>
        {canScrollPrev && (
          <Button
            ...
            size={size}
            className={cn(
              'absolute  h-12 w-12 rounded-full  bg-[#202020]',
